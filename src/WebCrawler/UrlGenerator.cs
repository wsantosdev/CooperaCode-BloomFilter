...
{
    public static List<string> Generate(int count = 1_000)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            {
                0 => $"{words[random.Next(words.Length)]}{random.Next(1, 999)}",
    ...
    public static List<string> GenerateWithTld(int count = 1_000, string tld = ".club")
    {
        var urls = new List<string>(count);
